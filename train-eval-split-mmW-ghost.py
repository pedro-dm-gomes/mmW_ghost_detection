...
from datasets.labelled_ghost_mmW import MMW as Dataset_mmW
from datasets.labelled_ghost_mmW_eval import MMW as Dataset_mmW_eval
import importlib
...
parser.add_argument('--data-dir', default='/scratch/uceepdg/ghost_data/original/', help='Dataset directory')
...
parser.add_argument('--seq-length', type=int, default=25, help='Length of sequence [default: 30]')
parser.add_argument('--num-points', type=int, default=853, help='Number of points [default: 200]')
...
print("\n ==== MMW POINT CLODU DENOISING (GHOST DATASET) ====== \n")
...
def train_one_epoch(sess,ops,train_writer, epoch):
    ...
    total_frames = 500 *75 # BUG TO BE SOLVED
    nr_batches_in_a_epoch = int(total_frames/ ( BATCH_SIZE * SEQ_LENGTH) )
    #print("nr_batches_in_a_epoch:", nr_batches_in_a_epoch)
